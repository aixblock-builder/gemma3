...
class MyModel(AIxBlockMLBase):
    ...
    def action(self, command, **kwargs):
        ...
        Args:
            ...
            **kwargs: Variable keyword arguments including:
                ...
                For 'train' command:
                    - model_id (str): Model identifier (default: 'google/gemma-3-4b-it')
        ...
        if command.lower() == "execute":
            ...
            hf_model_id = kwargs.get("hf_model_id", "google/gemma-3-4b-it")
    ...
    def model(self, **kwargs):
        ...
        Args:
            model_id (str, optional): The model id to load from huggingface hub. Defaults to "google/gemma-3-4b-it".
        ...
        DESCRIPTION = """\
        # Gemma-3
        This space demonstrates model [Gemma-3](https://huggingface.co/google/gemma-3-4b-it), a code model fine-tuned for chat instructions.
        """
